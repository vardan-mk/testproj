...
import am.iravaban.templates.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link am.iravaban.templates.domain.Template}.
 */
@RestController
@RequestMapping("/api")
public class TemplateResource {
    ...
    private static final String ENTITY_NAME = "templateServiceTemplate";
